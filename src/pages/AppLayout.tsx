...
export default function AppLayout() {
  ...
  return (
    <div className="flex h-screen bg-ink text-pearl overflow-hidden">
      ...
      <aside className="hidden md:flex w-60 bg-void border-r border-slate flex-col shrink-0">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Mobile top bar */}
        <div className="md:hidden flex items-center gap-3 px-4 py-3 bg-void border-b border-slate shrink-0">
          <button
        ...
        {/* ── Desktop Player bar ── */}
        <div className="hidden md:flex h-20 bg-void border-t border-slate px-6 items-center gap-6 shrink-0">
          {/* Track info + embed */}
        ...
        <div className="md:hidden bg-void border-t border-slate shrink-0">
          {/* Mini player row */}
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="w-10 h-10 shrink-0">
              {youtubeVideoId ? (
                ...
                <div className="w-10 h-10 rounded-lg bg-graphite flex items-center justify-center overflow-hidden">
                  {currentTrack?.thumbnail_url ? (
                    <img src={currentTrack.thumbnail_url} alt="" className="w-full h-full object-cover" />
                  ) : (
        ...
        <nav className="md:hidden flex items-center bg-void border-t border-slate shrink-0 safe-bottom">
          {navItems.map(({ to, icon: Icon, label, end }) => (
            <NavLink
              key={to}
              to={to}
